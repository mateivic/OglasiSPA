        ...
        <div class="form-div">
            <form class="form" @submit.prevent="addNewAd" @reset="closeForm">
                ...
                <div class="form-el">
                    ...
                    <textarea rows="4" placeholder="Unesite kratak opis oglasa" v-model="newAd.description"></textarea>
                </div>
                <h2 class="error" v-if="errorInPuttingIn">Provjerite jeste li dobro ispunili formu</h2>
...
export default {
    ...
    methods: {
        ...
        addNewAd() {
            if (this.newAd.title === "" || this.newAd.adOwner === "" || this.newAd.price === null) {
